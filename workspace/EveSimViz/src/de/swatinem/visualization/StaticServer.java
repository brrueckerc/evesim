 ...
 *
 */
class StaticServer extends HttpServlet {
    /**
	 * 
	 */
	private static final long serialVersionUID = 4270847030082113510L;
    ...
    public void init(ServletConfig config) throws ServletException {
        try {
            ...
            if (!t.hasMoreElements()) {
                logger.log(Level.SEVERE, "Web resources not available. Visualisations may not work. Please check if 'webroot.txt' is existing in the specified directory.");
            }
    ...
    protected void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (in == null) throw new IOException("Resource "+filename+" not found.");
