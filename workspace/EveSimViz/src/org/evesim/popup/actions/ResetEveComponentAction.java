...
public class ResetEveComponentAction implements IObjectActionDelegate  {

	private Shell shell;
	private EveComponent component;
	public final static Logger logger = Logger.getLogger(ResetEveComponentAction.class.getName());	
