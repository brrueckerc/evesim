...
public class AddServiceAction implements IObjectActionDelegate, IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		EveService pro = factory.createEveService();
		pro.setParent(comp);
		pro.setName("New Service");		
		comp.addChild(pro);
