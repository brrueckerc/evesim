...
public class AddPrototypeAction implements IObjectActionDelegate, IWorkbenchWindowActionDelegate{
	...
	public void run(IAction action) {
			...
			EvePrototype pro = factory.createEvePrototype();
			pro.setParent(comp);
			pro.setName("New Prototype");		
			comp.addChild(pro);
