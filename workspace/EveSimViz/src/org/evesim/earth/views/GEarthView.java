...
public class GEarthView extends Composite {
	
	public final static String STARTUP_URL = "http://localhost:@@port@@/vml/earth/index.html?sid=";
	...
	public GEarthView(Composite parent, int style, ResourceSet res) {
		super(parent, style);
