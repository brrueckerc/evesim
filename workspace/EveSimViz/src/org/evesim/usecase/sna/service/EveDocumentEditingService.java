...
public class EveDocumentEditingService implements FlypeerBusinessService, FlypeerServiceListener, FlypeerRollbackListener {
	private BasicPeer service_peer;
	public ArrayList<EveDocument> documents;
	private ArrayList<String> sessions;
	private String result;

	private final static Logger logger = Logger.getLogger(EveDocumentEditingService.class.getName());
	...
	public static void main(String[] args){
		EveDocumentEditingService serv = new EveDocumentEditingService();
		serv.start(null);
	...
	@Override
	public Serializable serviceEvent(ServiceContext params) throws Exception {

		//System.out.println(params);
		String call_session = (String)params.getParameter("session");
		String call_type  = (String)params.getParameter("type");
		String call_agent = (String)params.getParameter("agent");
		String call_document_name = (String)params.getParameter("document");
		String call_document_content = (String)params.getParameter("content");
		Integer call_count = (Integer)params.getParameter("count");
		Long call_timestamp = Long.valueOf(params.getParameter("timestamp").toString());
	...
	@Override
	public void rollback(ServiceContext args) {
