...
public class EveSendDocumentEditingStressTest {
	...
	public static void main(String[] args) {
		try {
			...
			serv.setSessionID(UUID.fromString("550e8400-e29b-11d4-a716-446655440000"));
			EveService serv1 = factory.createEveService();
			serv1.setName("Complex Robustness of Populations");
			serv1.setSessionID(UUID.fromString("550e8400-e29b-11d4-a716-446655440000"));
			...
			serv2.setSessionID(UUID.fromString("550e8400-e29b-11d4-a716-446655440000"));
			...
			timer.setGradient(new Float(-1.0));
			timer.setConstant(new Float(1000.0));
			timer.setMaxRepeat(1000);
			timer.setParent(agent);
			System.out.println(timer.getTimes(1000));
			timer.setCounter(0);
			...
			timerII.setGradient(new Float(-1.0));
			timerII.setConstant(new Float(1000.0));
			timerII.setMaxRepeat(1000);
			timerII.setParent(agentII);
			System.out.println(timerII.getTimes(1000));
			timerII.setCounter(0);
			...
			//sendResource("http://10.20.20.166:8080/eve/550e8400-e29b-11d4-a716-446655440000/init", resource);
			...
			//sync.addConnection("http://10.20.20.166:8080/eve/550e8400-e29b-11d4-a716-446655440000/msg");//deploy
