...
public class MonitorAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MonitorSwitch<Adapter> modelSwitch =
		new MonitorSwitch<Adapter>() {
			@Override
			public Adapter caseEveMonitorNode(EveMonitorNode object) {
				return createEveMonitorNodeAdapter();
			}
			@Override
			public Adapter caseEveMonitorPeerGroup(EveMonitorPeerGroup object) {
				return createEveMonitorPeerGroupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.evesim.monitor.EveMonitorNode <em>Eve Monitor Node</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEveMonitorNodeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.evesim.monitor.EveMonitorPeerGroup <em>Eve Monitor Peer Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEveMonitorPeerGroupAdapter() {
		return null;
	}
